  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">  
      ...
      <div class="form-group">
        ...
        <div class="field">
  <input class="layui-input" id="endTime" name="endTime" placeholder="自定义日期格式" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"  style="width:200px;">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
