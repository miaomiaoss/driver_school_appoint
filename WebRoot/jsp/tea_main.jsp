...
<div class="leftnav">
  ...
  <ul>
    <li><a href="tea/GetCourseInfoBySession" target="right"><span class="icon-caret-right"></span>授课学员信息表</a></li>
  </ul>
  ...
  <h2><span class="icon-pencil-square-o"></span>学生反馈信息</h2>
    <ul>
    <li><a href="teacher/getTeacherAssmentList" target="right"><span class="icon-caret-right"></span>学生反馈</a></li>
  </ul>
