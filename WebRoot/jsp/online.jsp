...
<body>
   <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 在线升级包</strong></div>
    ...
    <form action="file/upload" id="onlineSub" enctype="multipart/form-data" method="POST">
      <ul class="search" style="padding-left:10px;">
        <li> <input type="file" name="myFile" id="myFile" class="button border-main icon-plus-square-o" /> <a class="button border-main icon-plus-square-o" href="javascript:void(0);" onclick="upload()">上传 </a> </li>
         <input type="hidden" name="upType" value="online"/>
       </ul>
      </form>
    </div>
 ...
 <input type="hidden" name="download_type" value="online"/>
 </form>
	    ...
	    ,jump: function(obj, first){
	        if(!first){
	           ...
	           $.ajax({
	     	       type:"POST",
	     	       url: "user/targetList",
	     	       data:{pageNum:obj.curr,upType:"online"
	     	       },
	     	       dataType:"json",
	     	       contentType:"application/x-www-form-urlencoded;charset=utf-8",
	     	       success:function(data){
