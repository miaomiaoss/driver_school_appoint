...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 排课</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="user/getStuInfoById">
      <div class="form-group">
        <div class="label">
          <label for="sitename">排课对象账号：</label>
        </div>
        <div class="field">
